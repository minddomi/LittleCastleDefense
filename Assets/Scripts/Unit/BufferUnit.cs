...
public class BufferUnit : MonoBehaviour
{
    ...
    private readonly Dictionary<AllyUnit.UnitGrade, BuffData> buffTable = new()
    {
        ...
        { AllyUnit.UnitGrade.Intermediate, new BuffData { range = 3.0f, powerMultiplier = 1.0f, attackSpeedMultiplier = 1.0f, critChanceBonus = 0.00f, resourceBonus = 0 } },
    ...
    void ApplyBuff()
    {
        ...
        switch (self.unitGrade)
        {
            case AllyUnit.UnitGrade.Intermediate:
                ...
                data.attackSpeedMultiplier = 1.0f + (self.attackPower * 0.1f);
                break;
